...
function M.init(env)
    ...
    -- 定义固定词典文件的路径
    local paths = {
        rime_api.get_user_data_dir() .. "/cn_dicts_xh/custom_phrase/custom_phrase_super_1jian.txt",
        rime_api.get_user_data_dir() .. "/cn_dicts_xh/custom_phrase/custom_phrase_super_2jian.txt",
        rime_api.get_user_data_dir() .. "/cn_dicts_xh/custom_phrase/custom_phrase_super_3jian.txt"
    }
